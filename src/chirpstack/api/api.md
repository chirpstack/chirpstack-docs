...
- [api/internal.proto](#api_internal-proto)
    ...
    - [GetRegionRequest](#api-GetRegionRequest)
    - [GetRegionResponse](#api-GetRegionResponse)
    ...
    - [ListRegionsResponse](#api-ListRegionsResponse)
    - [LogItem](#api-LogItem)
    - [LogItem.PropertiesEntry](#api-LogItem-PropertiesEntry)
    - [LoginRequest](#api-LoginRequest)
    - [LoginResponse](#api-LoginResponse)
    - [OAuth2](#api-OAuth2)
    - [OAuth2LoginRequest](#api-OAuth2LoginRequest)
    - [OAuth2LoginResponse](#api-OAuth2LoginResponse)
    ...
    - [RegionChannel](#api-RegionChannel)
    - [RegionListItem](#api-RegionListItem)
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| online_count | [uint32](#uint32) |  | Online count. |
| offline_count | [uint32](#uint32) |  | Offline count. |
| never_seen_count | [uint32](#uint32) |  | Never seen count. |
...
<a name="api-GetRegionResponse"></a>
...
| id | [string](#string) |  | ID. |
| region | [common.Region](#common-Region) |  | Region. |
| user_info | [string](#string) |  | User information. |
| uplink_channels | [RegionChannel](#api-RegionChannel) | repeated | Uplink channels. |
| rx1_delay | [uint32](#uint32) |  | RX1 delay. |
| rx1_dr_offset | [uint32](#uint32) |  | RX1 data-rate offset. |
| rx2_dr | [uint32](#uint32) |  | RX2 DR. |
| rx2_frequency | [uint32](#uint32) |  | RX2 frequency. |
| class_b_ping_slot_dr | [uint32](#uint32) |  | Class-B ping-slot DR. |
| class_b_ping_slot_frequency | [uint32](#uint32) |  | Class-B ping-slot frequency. |
| description | [string](#string) |  | Region description. |
...
<a name="api-GetVersionResponse"></a>
...
| limit | [int64](#int64) |  | Max number of results to return. If not set, it will be treated as 0, and the response will only return the total_count. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| limit | [uint32](#uint32) |  | Max number of items to return. If not set, it will be treated as 0, and the response will only return the total_count. |
| offset | [uint32](#uint32) |  | Offset in the result-set (for pagination). |
...
<a name="api-ListRegionsResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| regions | [RegionListItem](#api-RegionListItem) | repeated | Configured regions. |
...
<a name="api-OAuth2LoginRequest"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| code | [string](#string) |  | OAuth2 callback code. |
| state | [string](#string) |  | OAuth2 callback state. |
...
<a name="api-OAuth2LoginResponse"></a>
...
| dr_min | [uint32](#uint32) |  | Min DR. |
| dr_max | [uint32](#uint32) |  | Max DR. |
...
| oauth2 | [OAuth2](#api-OAuth2) |  | OAuth2 settings. |
| tileserver_url | [string](#string) |  | Tileserver URL. |
| map_attribution | [string](#string) |  | Map attribution. |
...
| OAuth2Login | [OAuth2LoginRequest](#api-OAuth2LoginRequest) | [OAuth2LoginResponse](#api-OAuth2LoginResponse) | OAuth2 login. |
...
| ListRegions | [.google.protobuf.Empty](#google-protobuf-Empty) | [ListRegionsResponse](#api-ListRegionsResponse) | ListRegions lists the available (configured) regions. |
| GetRegion | [GetRegionRequest](#api-GetRegionRequest) | [GetRegionResponse](#api-GetRegionResponse) | GetRegion returns the region details for the given region. |
| GetVersion | [.google.protobuf.Empty](#google-protobuf-Empty) | [GetVersionResponse](#api-GetVersionResponse) | GetVersion returns the ChirpStack version. |
