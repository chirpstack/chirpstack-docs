...
using [Protobuf](https://developers.google.com/protocol-buffers) (see
`api/proto/gw/gw.proto` in
[chirpstack](https://github.com/chirpstack/chirpstack) for the Protobuf message
definitions).
